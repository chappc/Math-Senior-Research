...
\begin{figure}[h]
    ...
    \caption{This figure includes in addition the perpendicular from the point of tangency to the axis of the cone. The distance $L''$ is from the light source to the intersection of this perpendicular with the axis.}
    \label{fig:shadow_2}
\end{figure}
